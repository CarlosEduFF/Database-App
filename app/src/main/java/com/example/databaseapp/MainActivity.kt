...
import viewModel.Repository

class MainActivity : ComponentActivity() {
/* Este método prepara um construtor para a criação do arquivo de banco de dados pessoa.db*/
    ...
    /* Este método define a criação de uma factory(Fabrica) na ViewModel
    * no qual poderá requisitar funções SQL e se conectar ao banco*/
...
fun App(viewModel: PessoaViewModel, mainActivity: MainActivity){
    ...
    Column(
        ...
        Row(
            ...
            TextField(value = telefone, onValueChange = {telefone = it}, label = { Text(text = "Telefone")})
        }
        Row(
            Modifier
                .padding(20.dp)
